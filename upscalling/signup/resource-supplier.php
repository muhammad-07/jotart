<!-- Form -->
<form method="post" class="signup-forms" id="rs-form">
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                <div class="submit-field">
                    ...
                    <select class="selectpicker with-border" title="">
                        <option>Basic</option>
            ...
            <div class="col-xl-4 col-md-4">
                ...
                <div class="radio">
                    ...
                    <label for="radio-1"><span class="radio-label"></span> Married</label>
                    <input id="radio-2" name="radio" type="radio">
                    <label for="radio-2"><span class="radio-label"></span> Un-married</label>
                </div>
            ...
            <div class="content with-padding padding-bottom-10">
                <div class="single-page-section">
                    ...
                    <p>
                        Emphasize your expertise in consulting arising from education, employment or in practice.
                    </p>
                </div>
                <div class="row">
                    <div class="col-xl-12">
            ...
            <div class="content with-padding padding-bottom-10">
                <div class="single-page-section">
                    ...
                    <p>
                    I.	Knowledge and experience on supplying resources
                    </p>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="submit-field">
                            <!-- <h5>Executive summary</h5> -->
                            <textarea cols="30" rows="5" placeholder="Consulting knowledge from academic studies" class="with-border"></textarea>
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="submit-field">
                            <!-- <h5>Executive summary</h5> -->
                            <textarea cols="30" rows="5" placeholder="Consulting knowledge from formal employment" class="with-border"></textarea>
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="submit-field">
                            <!-- <h5>Executive summary</h5> -->
                            <textarea cols="30" rows="5" placeholder="Consulting knowledge from self employment" class="with-border"></textarea>
                        </div>
                    </div>
                ...
                <div class="row">
                    <p>
                        II. State economic sector you would like to invest in.
                    </p>
                    <div class="col-xl-12">
                        <div class="submit-field">
                            <!-- <h5>Executive summary</h5> -->
                ...
                <div class="row">
                    <p>III.List resources you supply.</p>
                    <div class="col-xl-12">
                ...
                <div class="row">
                    <p>IV. State sources of your resources</p>
                    <div class="col-xl-12">
                ...
                <div class="row">
                    <p>
                    V. State your experience in supplying resources to entrepreneurs
                    </p>
                    <div class="col-xl-12">
                        <div class="submit-field">
                            <!-- <h5>Executive summary</h5> -->
                ...
                <div class="row">
                    <p>
                    VI. In your own words make a statement on your suitability as a supplier of resources
                    </p>
                    <div class="col-xl-12">
                        <div class="submit-field">
                            <!-- <h5>Executive summary</h5> -->
                ...
                <div class="row">
                    <p>VII. State your payment arrangements with your customers </p>
                    <div class="col-xl-12">
                        <div class="submit-field">
                            <!-- <h5>Executive summary</h5> -->
                ...
                <div class="row">
                    <p>
                    VIII. Indicate whether you would be willing to supply resources and paid in part or whole by being issued with shares in the company
                    </p>
                    <div class="col-xl-12">
                        <div class="submit-field">
                            <!-- <h5>Executive summary</h5> -->
