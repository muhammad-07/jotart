...
<div class="modal fade popup is__dark" id="popup_social_media" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body space-y-20 p-40">
                ...
                <div class="d-flex flex-column">
                    <span class="nameInput mb-10">Select Mint</span>
                    <select type="text" class="form-control" placeholder="telegram username">
                        <option>BCD</option>
                    ...
                    <img class="align-self-center mt-10" id="output" style="max-width: 150px; max-height: 150px;" />
                    <input
                        class="telegram-btn btn btn-primary mt-20
                                                        btn-sm w-100"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0 ajax-alert">
                    ...
                    <div class="form-group">
                        <input class="form-control" placeholder="{{ __('Email Address') }}" name="email"
                            type="email" required>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <input class="form-control" placeholder="{{ __('First name') }}" name="first_name"
                                    type="text" required>
                            </div>
                            <div class="col-12 col-lg-6">
                                <input class="form-control" placeholder="{{ __('Last name') }}" name="last_name"
                                    type="text" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-control password" placeholder="{{ __('Password') }}" type="password"
                            name="password" required>
                        <span class="toggle cursor fas fa-eye pass-icon"></span>
                    </div>

                    <div class="form-group">
                        <input class="form-control password" placeholder="{{ __('Confirm Password') }}"
                            type="password" name="password_confirmation" required>
                        <span class="toggle cursor fas fa-eye pass-icon"></span>
                    </div>

                    <div class="form-group">
                        <button class="click-to-verify">{{ __('Click to verify') }} <img
                                src="{{ asset('assets/user/img/sign-in-img/verify-avatar.svg') }}"
                                alt="{{ __('avatar') }}"></button>
                    </div>

                    <div class="terms-policy-box">
                        <label class="d-flex align-items-start">
                            <input type="checkbox" checked="checked" name="remember">
                            <span>{{ __('By creating an account you agree to our') }} <a href="#"
                                    class="color-green">{{ __('Privacy Policy') }}</a> and <a href="#"
                                    class="color-green">{{ __('Terms of Service.') }}</a></span>
                        </label>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-0 ajax-alert">
                    ...
                    <div class="form-group">
                        <input class="form-control password" placeholder="{{ __('Password') }}" name="password"
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="main-item">
                        <div class="row justify-content-center">
                                    ...
                                    <div class="main-item-views-love d-flex align-items-center justify-content-between">
                                        <div class="main-item-views-part d-flex align-items-center">
                                            ...
                                            <span>{{ __('In stock:') }} <span
                                                    id="in-stock-item">{{ __('0') }}</span></span>
                                        </div>
                                        <div class="main-item-love-part">
                                            <button class="color-red"><i class="far fa-heart"></i></button>
                                            <span class="font-weight-bold color-heading">{{ __('0') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="main-item-leftside-box">
                                        <div class="current-bid-box">
                                            ...
                                            <div class="bid-price-box">
                                                <h2><span id="price-dollar-service">{{ __('0.00') }}</span> <span
                                        ...
                                        <div class="owner-creator-box">
                                            <div class="owner-box">
                                                <img src="{{ isset(Auth::user()->photo)? asset(IMG_USER_VIEW_PATH . Auth::user()->photo): Avatar::create(Auth::user()->first_name . ' ' . Auth::user()->last_name)->toBase64() }}"
                                                    alt="{{ __('owner') }}">
                                                <h6>{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}
                                                </h6>
                                                <p>{{ __('Owner') }}</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="main-item-leftside-box">
                                        <div class="highest-bid-box d-flex align-items-center justify-content-between">
                                            <div class="highest-box-item d-flex align-items-center">
                                                <img src="{{ asset('assets/user/img/main-item-img/color-icon.png') }}"
                                                    alt="{{ __('bid') }}">
                                            ...
                                            <div class="highest-box-item d-flex align-items-center">
                                                <img src="{{ asset('assets/user/img/main-item-img/country-icon.png') }}"
                                                    alt="{{ __('bid') }}">
                                                <div class="highest-box-text">
                                                    <p>{{ __('Origin') }}</p>
                                        ...
                                        <div class="main-item-btn-box">
                                            <button
                                                class="theme-button1 w-100 disabled">{{ __('Purchase Now') }}</button>
                                            <button
                                                class="theme-button2 w-100 disabled">{{ __('Place a Bid') }}</button>
                                        </div>
                                    </div>
                                    <!-- Main Item Leftside Box End -->
                                </div>
                            ...
                            <div class="">
                                <div class="main-item-img-part position-relative d-flexxx justify-content-center">
                                    <div class="main-item-img" style="margin-top: 130px">
                                        <img src="{{ asset('assets/user/img/main-item-img/create-new-preview.jpg') }}"
                                            id="target2" alt="{{ __('item') }}">
                                        <video id="target2_video" width="300" height="300" controls muted></video>
                                    </div>
                                    <!-- Countdown box start -->
                                    <div class="countdown-box" style="margin-top: 40px">
                                        <span class="bg-green time-remaining">{{ __('Expired Date') }}</span>
                                        <div class="countdown" style="padding-top:20px">
                                            <div class="timer-down-wrap"><span
                                                    id="hours1">{{ __('06') }}</span><span
                                                    class="timing-title">{{ __('Hrs') }}</span></div>
                                            <div class="timer-down-wrap"><span
                                                    id="minutes1">{{ __('35') }}</span><span
                                                    class="timing-title">{{ __('Min') }}</span></div>
                                            <div class="timer-down-wrap"><span
                                                    id="seconds1">{{ __('54') }}</span><span
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="change-price-box checkout-content-box">
                        ...
                        <div id="checkout-event" class="ajax-alert">
                            @if ($service->type == 1)
                                <p class="preview-inner-modal-info">
                                    {{ __('You have to pay ') . visual_number_format($service->price_dollar) . __(' USD') }}
                                </p>
                            ...
                            <input type="hidden" name="on_service_fee" id="on_service_fee"
                                value="{{ serviceChargeBuyer($service->price_dollar) }}">
                            <input type="hidden" name="on_receiver_fee" id="on_receiver_fee"
                                value="{{ serviceChargeSeller($service->price_dollar) }}">
                            ...
                            @elseif($service->type == 2)
                                <div class="form-group">
                                    <label
                                        for="">{{ hasPreviousBid($service->id) == 1 ? __('Increase Bid Amount') : __('Bid Amount') }}</label>
                                    <input type="number" min="1" step="0.00000001" placeholder="Amount"
                                        class="form-control" value="" name="price" id="price">
                                </div>
                            @endif
                            <div class="form-group">
                                ...
                                <select name="wallet_id" id="wallet_id" class="form-control">
                                    ...
                                    @foreach (coinListUser() as $wallet)
                                        <option value="{{ $wallet->id }}">
                                            {{ $wallet->coin->full_name . ' (' . $wallet->coin->coin_type . ')' }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="preview-inner-modal-btn">
                            <button class="theme-button1 w-100"
                                type="submit">{{ __('I understand & continue') }}</button>
                    ...
                    <div class="change-price-box checkout-content-box">
                        <div class="purchasing-process-box align-items-center" id="purchase-loader">
                            ...
                            <div class=" purchasing-process-right">
                                ...
                                <div class="steps__text text-danger">
                                    {{ __('You can not purchase or bid in your product') }}</div>
                            </div>
                        </div>
                    </div>
                    <!-- Change Price Modal Box End -->
                    ...
                    <div class="purchasing-process-box align-items-center" id="purchase-loader">
                        ...
                        <div class=" purchasing-process-right">
                            ...
                            <div class="steps__text">
                                {{ __('You are not login! Please login first.') }}<br><br><a data-dismiss="modal"
                                    data-toggle="modal" href="#signInModal" class="theme-button1 nav-upload"
                                    id="login-first">{{ __('Login Now') }}</a></div>
                        </div>
                    </div>
                </div>
                <!-- Change Price Modal Box End -->
