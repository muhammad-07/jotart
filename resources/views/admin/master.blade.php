    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ route('admin_dashboard') }}" class="brand-link">
                <img src="{{ asset('assets/img/logos/Jot-Art-Icon.png') }}" alt="{{ __('logo') }}"
                    class="brand-image img-circle elevation-3">
                <span class="brand-text font-weight-light">{{ __('JotArt') }}</span>
            </a>
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin_users') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'user') active @endif">
                        ...
                        <li class="nav-item @if (isset($menu) && $menu == 'coin') menu-open @endif">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('coin_list') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'coin_list') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Coin List') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('api_settings') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'api-settings') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Coin API') }}</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item @if (isset($menu) && $menu == 'wallet') menu-open @endif">
                            <a href="{{ route('admin_wallet_list') }}"
                                class="nav-link @if (isset($menu) && $menu == 'wallet') active @endif">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('deposit_history') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'deposit') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Deposit') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin_pending_withdrawal') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'withdrawal') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Withdrawal') }}</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item @if (isset($menu) && $menu == 'service-transaction') menu-open @endif">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin_all_transaction') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'all-transactions') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('All Transactions') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin_transaction_settings') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'transaction-settings') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                        ...
                        <li class="nav-item @if (isset($menu) && $menu == 'category_list') menu-open @endif">
                            <a href="{{ route('admin_category_list') }}"
                                class="nav-link @if (isset($menu) && $menu == 'category_list') active @endif">
                        ...
                        <li class="nav-item @if (isset($menu) && $menu == 'service_list') menu-open @endif">
                            <a href="{{ route('admin_service_list') }}"
                                class="nav-link @if (isset($menu) && $menu == 'service_list') active @endif">
                        ...
                        <li class="nav-item @if (isset($menu) && $menu == 'subscribers') menu-open @endif">
                            <a href="{{ route('admin_subscriber_list') }}"
                                class="nav-link @if (isset($menu) && $menu == 'subscribers') active @endif">
                        ...
                        <li class="nav-item @if (isset($menu) && $menu == 'news_list') menu-open @endif">
                            <a href="{{ route('admin_news_list') }}"
                                class="nav-link @if (isset($menu) && $menu == 'news_list') active @endif">
                        ...
                        <li class="nav-item @if (isset($menu) && $menu == 'faq') menu-open @endif">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin_faq_heading') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'heading') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Heading') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin_faq_content') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'contents') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Contents') }}</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin_settings') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'general') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin_slider') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'slider') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Slider') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin_contents') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'contents') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Contents') }}</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin_counters') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'counters') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Counters') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin_payment_setting') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'payment-method') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
                                        <p>{{ __('Payment Method') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('withdrawal_coin_settings') }}"
                                        class="nav-link @if (isset($sub_menu) && $sub_menu == 'withdrawal-limit') active @endif">
                                        <i class="fas fa-window-minimize nav-icon"></i>
        ...
        <footer class="main-footer">
            <strong>{{ __('Copyright &copy; 2022') }} <a href="javascript:void(0)">{{ __('JotArt') }}</a>.</strong>
