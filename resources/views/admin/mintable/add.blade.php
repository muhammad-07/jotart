...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Add Mintable') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">{{ __('Mintable') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('Add Mintable') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('Add Mintable') }}</h3>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-12" id="price-d">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" min="0" class="form-control"
                                                        id="price" name="price_dollar" placeholder="{{ __('Price') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-lg-6 d-none" id="max_bid_d">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" min="0" class="form-control"
                                                        id="max_bid_amount" name="max_bid_amount" value="999999">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6 d-none" id="min_bid_d">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" min="0" class="form-control"
                                                        id="min_bid_amount" name="min_bid_amount" value="0.01">
                                                </div>
                                            </div>
                        ...
                        <div class="create-new-page-box-inner d-flex justify-content-between align-items-center">
                            ...
                            <div class="save-or-not-msg" id="file-saved">{{ __('File Saved !') }}</div>
                                ...
                                <div class="col-12 col-md-5 col-lg-5">
                                    <!-- Create New Box Start -->
                                    <div class="create-new-page-box">
                                        <h6 class="create-new-page-box-title font-weight-bold">{{ __('Upload file') }}
                                        </h6>
                                        <p>{{ __('Drag or choose your file to upload') }}</p>
                                        <div class="form-group custom-file-upload">
                                            <input type="file" class="custom-file-inputxxx putImage1" id="customFile"
                                                name="thumbnail">
                                            <span
                                ...
                                <label class="custom-file-label" for="customFile">
                                    ...
                                    <div class="create-new-page-box">
                                        <div class="create-new-page-box-inner d-flex justify-content-between">
                                            <div>
                                                <h6 class="create-new-page-box-title font-weight-bold">
                                                    {{ __('Preview') }}</h6>
                                            </div>
                                            {{-- <div>
                                <button type="button" class="color-green show-full-preview" data-toggle="modal"
                                    ...
                                    <button type="submit" class="btn btn-info mt-2">Add Mintable</button>
                                </div>
